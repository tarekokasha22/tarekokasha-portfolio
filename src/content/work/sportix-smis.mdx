...
Sole engineer. Next.js, TypeScript, Supabase, Tailwind CSS. WhatsApp Business API for notifications. Custom Hijri/Gregorian calendar utilities. Federation-specific export modules built per sport.
